...
// DetectRequestMeta delegates then re-labels Provider as "xai".
// xAI keys typically begin with the `xai-` prefix and travel as Bearer;
// classify them under the "xai-bearer" key class.
