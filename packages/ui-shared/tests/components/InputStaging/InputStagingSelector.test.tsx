...
import { InputStagingSelector } from '../../../src/components/InputStaging/InputStagingSelector';
import type { InputStagingStrategy } from '../../../src/components/InputStaging/suggest';
...
describe('InputStagingSelector — i18n key parity (EN/ZH/ES shared.json)', () => {
  ...
  async function checkLocale(locale: string) {
    const json = await import(`../../../src/i18n/${locale}/shared.json`);
