...
const PATHS: Record<InlineGlyphName, ReactNode> = {
  lock: (
    <>
  ...
  rocket: (
    <>
      ...
      <path d="M9 12H4s.55-3.03 2-4a5 5 0 0 1 3 0M15 9v5s3.03-.55 4-2a5 5 0 0 0 0-3" />
    </>
  ),
  smartphone: (
    <>
...
export interface InlineGlyphProps {
  name: InlineGlyphName;
  /** CSS class for sizing / spacing. */
  className?: string;
  /** When set, the glyph is exposed to assistive tech with this label. */
  title?: string;
}

export function InlineGlyph({ name, className, title }: InlineGlyphProps) {
  return (
    <svg
      className={className}
      width="1em"
