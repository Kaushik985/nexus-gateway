...
import { TrafficEventDetail } from '../../../src/pages/traffic/TrafficEventDetail';
...
// The drawer now fetches detail-by-id via react-query. Tests run without a
// Wails bridge, so agentApi.eventById throws and the query errors — the drawer
// falls back to the passed list row, which is exactly what these tests assert
// on. A no-retry client keeps the failure synchronous-ish and quiet.
