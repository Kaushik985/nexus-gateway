...
func (s *stubTransport) Do(_ context.Context, r *http.Request, _ CallTarget) (*http.Response, error) {
...
func (s *stubSchemaCodec) DecodeResponse(_ typology.WireShape, body []byte, _ string, _ DecodeContext) (DecodeResult, error) {
