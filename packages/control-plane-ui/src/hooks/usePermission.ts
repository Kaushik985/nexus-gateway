...
export const ACTION_MAP: Record<string, string> = {
  ...
  'oauth-client:read': 'admin:oauth-client.read',
  'oauth-client:create': 'admin:oauth-client.create',
  'oauth-client:update': 'admin:oauth-client.update',
  'oauth-client:delete': 'admin:oauth-client.delete',
  'oauth-client:rotate': 'admin:oauth-client.rotate',
