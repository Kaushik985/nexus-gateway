...
def main():
    ...
    ap.add_argument("--cp-user", default=os.environ.get("NEXUS_CP_USER") or os.environ.get("NEXUS_ADMIN_EMAIL"))
    ap.add_argument("--cp-pass", default=os.environ.get("NEXUS_CP_PASS") or os.environ.get("NEXUS_ADMIN_PASSWORD"))
