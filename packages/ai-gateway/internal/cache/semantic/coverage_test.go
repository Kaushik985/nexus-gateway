...
// coverage_test.go covers the remaining low-coverage paths that are not
// naturally exercised by the behavioural tests in the other _test.go files.
// All tests here are deterministic and do not make network calls.
