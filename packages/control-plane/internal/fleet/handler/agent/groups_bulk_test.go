...
// countingHub wraps a HubAPI and fails the Nth ForceResyncAll call to
// drive partial-success 207 paths. The mutex makes the counter safe for
// the goroutine-fanout under -race.
