...
func TestCodec_DecodeResponse_EmbeddingsDecoded(t *testing.T) {
	...
	decRes, err := codec{}.DecodeResponse(typology.WireShapeCohereEmbed, body, "")
	if err != nil {
		t.Fatalf("unexpected err: %v", err)
	}
...
func TestCodec_DecodeResponse_EmptyBody(t *testing.T) {
	decRes, err := codec{}.DecodeResponse(typology.WireShapeCohereChat, nil, "")
...
func TestCodec_DecodeResponse_InvalidJSON(t *testing.T) {
	_, err := codec{}.DecodeResponse(typology.WireShapeCohereChat, []byte(`{not json`), "")
...
func TestCodec_DecodeResponse_MissingFinishReasonDefaultsToStop(t *testing.T) {
	...
	decRes, err := codec{}.DecodeResponse(typology.WireShapeCohereChat, body, "")
	out := decRes.CanonicalBody
	if err != nil {
		t.Fatalf("unexpected err: %v", err)
	}
