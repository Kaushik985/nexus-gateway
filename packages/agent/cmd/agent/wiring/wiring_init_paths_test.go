...
// WireThingClientCallbacks and InitEnrollment tests live in
// runwiring_seams_test.go alongside the other cmdRun-seam tests.
...
func TestInitUpdater_Smoke(t *testing.T) {
	...
	u := InitUpdater(hubClient, false, 300, "1.0.0", "linux", "/usr/bin/nexus-agent", t.TempDir())
	if u == nil {
